        ...
        return (
            <div className='bg-black min-h-screen text-white'>
                ...
                <div className="max-w-6xl mx-auto px-4 py-8">
                    <h1 className="tetx-3xl font-bold mb-8">Search History</h1>
          ...
          {searchHistory?.map((entry) => (
            <div key={entry.id}
              className="bg-gray-800 p-4 rounded flex items-start">
                ...
                <Trash className='size-5 ml-4 cursor-pointer hover:fill-red-600 hover-text-red-600' onClick={async()=>handleDelete(entry)}></Trash>
           </div>     
          ))}
        </div>
      </div>

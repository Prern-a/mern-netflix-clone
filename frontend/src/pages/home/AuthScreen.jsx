...
const AuthScreen = () => {
  ...
  <div className="hero-bg relative">
    {/* {Navbar} */}
    <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-6">
      <img src="/netflix-logo.png" alt="logo" className="w-40" />
      <Link to ={'/login'} className='text-white bg-red-600 py-1 px-5 rounded font-medium'>
      Sign In</Link>
    </header>

    {/* {hero section} */}
    <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto ">
      <h1 className="text-4xl md:text-6xl font-extrabold mb-4 w-3/5">Unlimited Movies, TV  shows, and more </h1> 
        <h2 className="text-xl md:text-3xl font-bold mb-4">Watch anywhere. Cancel anytime.</h2> 
          <p className="text-sm md:text-lg font-bold mb-4">Ready to watch? Enter your email to create or restart your membership.</p>
    ...
    <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
      <input type='email' placeholder='Email address' className='p-2 rounded flex-1 bg-black/80 border border-gray-700' value={email} onChange={(e)=>setEmail(e.target.value)}/>
        <button className="bg-red-600 text-xl lg:red-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center">Get Started <ChevronRight className='size-8 md:size-10'/></button></form>
      ...
      <div className='py-10 bg-black text-white '>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          ...
          <div className='flex-1 text-center md:text-left'>
            ...
            <p className='text-lg md:text-xl'>Watch on Smart TVs Playstation, Xbox, ChromeCast, Apple TV, Blu-ray players and more.
            </p>
          </div>
      ...
      <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
        ...
        <div className="flex-1 md:text-left text-center">
          <h2 className='text-4xl md:text-5xl font-bold mb-4 text-balance'>
            Download your shows offline to watch offline
          </h2>
       ...
       <div className='py-10 bg-black text-white '>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          ...
          <div className='flex-1 text-center md:text-center'>
            ...
            <p className='text-lg md:text-xl'>Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV without paying more.
            </p>
          </div>
          {/* {right side} */}
                ...
                <div className="flex-1 relative">
                  ...
                  {/* {/right} */}
                   <div className='flex-1 text-center md:text-center'>
                      ...
                      <p className='text-lg md:text-xl'>Send kids on adventure with their favourite characters in a space made just for them-free with your membership.
                      </p>
                  </div>
